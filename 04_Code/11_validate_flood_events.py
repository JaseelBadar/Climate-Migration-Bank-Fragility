...
print(f"Districts in EM-DAT (first 200 chars): "
      f"{str(event1['districts_final_str'])[:200]}...")

exposed_2019q3 = df[
    (df['quarter'] == '2019Q3') &
    ((df['flood_exposure_ruleA_qt'] == 1) | (df['flood_exposure_ruleB_qt'] == 1))
]
...
ruleB_dists = (
    exposed_2019q3[exposed_2019q3['flood_exposure_ruleB_qt'] == 1]['district_gadm']
    .unique().tolist()
)
...
hp_districts_2023q2 = exposed_2023q2[
    (exposed_2023q2['state_gadm'] == 'Himachal Pradesh') &
...
delhi_districts_2023q2 = exposed_2023q2[
    (exposed_2023q2['state_gadm'] == 'NCT of Delhi') &
    (exposed_2023q2['flood_exposure_ruleA_qt'] == 1)
]
