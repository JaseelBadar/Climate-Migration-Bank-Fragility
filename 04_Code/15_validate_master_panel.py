...
# [3] 2016 detailed quarterly breakdown
...
# [3b] 2017 detailed quarterly breakdown — 2017Q1 must show 100% missing
print("\n[3b] 2017 DETAILED BREAKDOWN")
...
# [6] Compute gap quarter coverage dynamically for log — no hardcoding
q_2016Q3_miss = 100 * df[df['quarter'] == '2016Q3']['deposits'].isna().mean()
q_2016Q4_miss = 100 * df[df['quarter'] == '2016Q4']['deposits'].isna().mean()
q_2017Q1_miss = 100 * df[df['quarter'] == '2017Q1']['deposits'].isna().mean()
...
CRITICAL ISSUES:
1. 2016Q3: {q_2016Q3_miss:.1f}% missing deposits (RBI structural gap — source file boundary)
2. 2016Q4: {q_2016Q4_miss:.1f}% missing deposits (RBI structural gap — source file boundary)
3. 2017Q1: {q_2017Q1_miss:.1f}% missing deposits (RBI structural gap — same publication gap)
4. 2017 overall: {pct_2017_miss:.1f}% missing deposits (partial recovery from Q2 onward)
5. Treatment coverage: {treatment_cov:.1f}% of Rule A floods have deposit data


RECOMMENDATIONS:
- DROP 2016Q3, 2016Q4, AND 2017Q1 from analysis (all three are structural RBI gaps)
- INVESTIGATE 2017 remaining gaps Q2-Q4 (specific districts or states?)
- Use 2015-2024 with 2016Q3, 2016Q4, and 2017Q1 excluded
