...
log(f'\n  Rule A complete cases: {len(df_H3_A):,}')
...
log('  Regressors: flood_ruleA t0, t-1, t-2 | Quarter FE | Clustered SE')
...
# --- Save H3 output ---
h3_rows = []
for rule, lags, coefs, ses, tstats, pvals, cilos, cihis, sigs, n_obs, n_qfe in [
    ('A', ['t0', 't-1', 't-2'],
     ...
     int(model_H3_A.nobs), n_qfe_H3_A),
    ('B', ['t0', 't-1', 't-2'],
     ...
     int(model_H3_B.nobs), n_qfe_H3_B)
]:
